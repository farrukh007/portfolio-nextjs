      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col items-center pt-8">
          ...
          <p className="text-gray-500 dark:text-gray-300 text-center">
            Hey my name is Farrukh and I am a Full Stack Developer
          </p>
          <div className="flex space-x-5 pt-6">
            <a
              href="https://github.com/farrukh007?tab=repositories"
              target="_blank"
            >
              <svg
            ...
            <a
              href="https://pk.linkedin.com/in/farrukh-shoukat-ali-609bb718?trk=public_profile_samename-profile"
              target="_blank"
            >
              <svg
                viewBox="0 0 1024 1024"
            ...
            <a
              href="https://twitter.com/farrukh_zero?t=VAPEx3I3wQtFkNZu01NLjw&s=08"
              target="_blank"
            >
              <svg
                viewBox="0 0 1024 1024"
